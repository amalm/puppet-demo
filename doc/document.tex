...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.4\textwidth]{images/apache.png}
  \end{center}
  \caption{Zugriff auf den Webserver der Vagrant-Maschine}
  \label{puppet-user}
\end{figure}
