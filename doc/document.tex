...
Für die Übersetzung, UnitTests und Paketiereung der Applikation helfen Continous Integration Systeme wie \cite{jenkins}. Aber wie automatisert man der nächste Schritt - die automatische Installation und Konfiguration auf ein bis mehrere Servers? 
...
\begin{itemize}
\item trotz Paketierung in Web Archieves (WARs) war bisher einige Konfigurationen wie Datenbank-Parametern manuell einzutragen.
\end{itemize}
